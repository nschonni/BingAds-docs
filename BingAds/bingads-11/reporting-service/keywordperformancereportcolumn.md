...
|<a name="mainlinebid"></a>MainlineBid|Based on your campaign performance and marketplace dynamics, this estimate is the bid amount that Bing Ads calculates for your ad to be placed on the first page in the search results.<br/><br/>These estimates are provided as a reference only. They are automatically generated by Bing Ads and are not a guarantee of ad position.|
