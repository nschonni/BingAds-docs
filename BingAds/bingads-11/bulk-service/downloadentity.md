...
<xs:simpleType name="DownloadEntity" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:restriction base="xs:string">
    ...
    <xs:enumeration value="AudienceNetworkInMarketAudiences">
      <xs:annotation>
        <xs:appinfo>
    ...
    <xs:enumeration value="AudienceNetworkAudiences">
      <xs:annotation>
        <xs:appinfo>
...
|<a name="accountsitelink2adextensions"></a>AccountSitelink2AdExtensions|Include [Account Sitelink2 Ad Extension](account-sitelink2-ad-extension.md) records in the download that represents the association relationship between an account and a sitelink2 ad extension. For [Sitelink2 Ad Extension](sitelink2-ad-extension.md) records, you should include the Sitelink2AdExtensions value in the download request.|
...
|<a name="adgroupimageadextensions"></a>AdGroupImageAdExtensions|Include [Ad Group Image Ad Extension](ad-group-image-ad-extension.md) records in the download that each represent the association relationship between an ad group and an image ad extension. For [Image Ad Extension](callout-ad-extension.md) records, you should include the ImageAdExtensions value in the download request.|
...
|<a name="adgroupsitelink2adextensions"></a>AdGroupSitelink2AdExtensions|Include [Ad Group Sitelink2 Ad Extension](ad-group-sitelink2-ad-extension.md) records in the download that each represent the association relationship between an ad group and a sitelink2 ad extension. For [Sitelink2 Ad Extension](sitelink2-ad-extension.md) records, you should include the Sitelink2AdExtensions value in the download request.|
...
|<a name="audiencenetworkaudiences"></a>AudienceNetworkAudiences|Include [Custom Audience](custom-audience.md), [In Market Audience](in-market-audience.md), [Product Audience](product-audience.md), and [Remarketing List](remarketing-list.md) records in the download data. The download will include in-market audiences that are only supported with the Audience network. If you use the Audiences value in Bing Ads API Version 11 the in-market audiences that are only supported with the Audience network are not included. In Bing Ads API Version 12 the AudienceNetworkAudiences value is removed and all in-market audiences will be included by including the Audiences value in the download request.<br/><br/> The [DownloadCampaignsByAccountIds](downloadcampaignsbyaccountids.md) and [DownloadCampaignsByCampaignIds](downloadcampaignsbycampaignids.md) operations return the same set of audiences for the current authenticated user. All audiences that have Scope set to Customer are included. The audiences that have Scope set to Account are also included if the user has access to view or manage those accounts. In other words, if an audience is in account scope for an account that the user cannot access, then it is excluded from the download results.<br/><br/> To get audiences by type instead of requesting all types of audiences, you can include one or more of the CustomAudiences, InMarketAudiences, ProductAudiences, and RemarketingLists values in the download request.|
|<a name="audiencenetworkinmarketaudiences"></a>AudienceNetworkInMarketAudiences|Include [In Market Audience](in-market-audience.md) records in the download data, including in-market audiences that are only supported with the Audience network. If you use the InMarketAudiences value in Bing Ads API Version 11 the in-market audiences that are only supported with the Audience network are not included. In Bing Ads API Version 12 the AudienceNetworkInMarketAudiences value is removed and all in-market audiences will be included by including the InMarketAudiences value in the download request.<br/><br/> The [DownloadCampaignsByAccountIds](downloadcampaignsbyaccountids.md) and [DownloadCampaignsByCampaignIds](downloadcampaignsbycampaignids.md) operations return the same set of in-market audiences for the current authenticated user. All in-market audiences that have Scope set to Customer are included. The in-market audiences that have Scope set to Account are also included if the user has access to view or manage those accounts. In other words, if an in-market audience is in account scope for an account that the user cannot access, then it is excluded from the download results.|
|<a name="audiences"></a>Audiences|Include [Custom Audience](custom-audience.md), [In Market Audience](in-market-audience.md), [Product Audience](product-audience.md), and [Remarketing List](remarketing-list.md) records in the download data. To download in-market audiences that are only supported with the Audience network, you must include the AudienceNetworkAudiences value in the download request. Otherwise by default in Bing Ads API Version 11 they are not included. In Bing Ads API Version 12 all in-market audiences will be included with the Audiences value in the download request.<br/><br/> The [DownloadCampaignsByAccountIds](downloadcampaignsbyaccountids.md) and [DownloadCampaignsByCampaignIds](downloadcampaignsbycampaignids.md) operations return the same set of audiences for the current authenticated user. All audiences that have Scope set to Customer are included. The audiences that have Scope set to Account are also included if the user has access to view or manage those accounts. In other words, if an audience is in account scope for an account that the user cannot access, then it is excluded from the download results.<br/><br/> To get audiences by type instead of requesting all types of audiences, you can include one or more of the CustomAudiences, InMarketAudiences, ProductAudiences, and RemarketingLists values in the download request.|
...
|<a name="campaigns"></a>Campaigns|Include [Campaign](campaign.md) records in the download data.<br/><br/>New campaign types can be added anytime, so please be sure to leverage the [Campaign Type](campaign.md#campaigntype) field to filter as needed.|
|<a name="campaignsitelink2adextensions"></a>CampaignSitelink2AdExtensions|Include [Campaign Sitelink2 Ad Extension](campaign-sitelink2-ad-extension.md) records in the download that represents the association relationship between a campaign and a sitelink2 ad extension. For [Sitelink2 Ad Extension](sitelink2-ad-extension.md) records, you should include the Sitelink2AdExtensions value in the download request.|
...
|<a name="inmarketaudiences"></a>InMarketAudiences|Include [In Market Audience](in-market-audience.md) records in the download data. To download in-market audiences that are only supported with the Audience network, you must include the AudienceNetworkInMarketAudiences value in the download request. Otherwise by default in Bing Ads API Version 11 they are not included. In Bing Ads API Version 12 all in-market audiences will be included with the InMarketAudiences value in the download request.<br/><br/> The [DownloadCampaignsByAccountIds](downloadcampaignsbyaccountids.md) and [DownloadCampaignsByCampaignIds](downloadcampaignsbycampaignids.md) operations return the same set of in-market audiences for the current authenticated user. All in-market audiences that have Scope set to Customer are included. The in-market audiences that have Scope set to Account are also included if the user has access to view or manage those accounts. In other words, if an in-market audience is in account scope for an account that the user cannot access, then it is excluded from the download results.|
...
|<a name="sitelink2adextensions"></a>Sitelink2AdExtensions|Include [Sitelink2 Ad Extension](sitelink2-ad-extension.md) records in the download data.<br/><br/> To get all sitelink2 ad extensions from your account's extension library, use the [DownloadCampaignsByAccountIds](downloadcampaignsbyaccountids.md) operation. To get only the sitelink2 ad extensions that are associated with entities within the specified campaigns, use the [DownloadCampaignsByCampaignIds](downloadcampaignsbycampaignids.md) operation.|
